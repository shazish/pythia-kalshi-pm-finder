...
2. Add a new pitfalls entry (#N+1) with:
   ...
   - Impact assessment
   - Lesson for future
3. Run regression: `python3 pythia-main finalize` — verify no Kalshi-side regressions
...
- **`terminal`**: Best for running `python3 pythia-main finalize` since it uses system python which has openpyxl for Excel export.
