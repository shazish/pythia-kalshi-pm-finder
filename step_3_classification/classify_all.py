...
Usage:
    python3 step_3_classification/classify_all.py [--run-dir RUN_DIR] [--model MODEL]
...
from step_2_research.research_utils import filter_research_entry
...
if args.mode == "subagent":
    ...
    print(f"     python3 step_4_verify/verify_classifications.py")
...
if args.mode == "auto":
    try:
        from shared.session_utils import in_opencode_session, suggest_subagent_mode
...
print("\nNext  : python3 step_4_verify/verify_classifications.py")
